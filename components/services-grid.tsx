        ...
        return (
          ...
          >
            ...
            <Link
              ...
              className="group relative z-10 flex h-full flex-col rounded-lg border border-white/10 bg-[#0A1626] p-6 transition-[border-color,transform] duration-150 hover:border-[#3B82F6]/40 active:scale-[0.98]"
            >
              ...
              <span className="mt-auto inline-flex items-center gap-1.5 pt-4 text-xs font-semibold uppercase tracking-[0.1em] text-[#3B82F6]">
                Ver alcance
